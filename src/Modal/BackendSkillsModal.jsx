...
const BackendSkillsModal = (props) => {
        ...
        </div>
    {
        ...
        <div className='w-full h-full flex items-center justify-center backdrop-blur-md bg-transparent gap-10  fixed inset-0 z-50 p-5'>
            <div key={props.id} className="main flex flex-col gap-5 dark:bg-white dark:text-black dark:border-0 shadow-black shadow p-4 w-96 rounded-md bg-white text-black">
...
export default BackendSkillsModal